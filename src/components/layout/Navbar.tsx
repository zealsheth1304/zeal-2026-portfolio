                            ...
                            >
                                <nav className="flex flex-col p-6 gap-6">
                                    ...
                                    <div className="flex items-center gap-6 pt-2">
                                        ...
                                        <a href="https://www.instagram.com/zealsheth.design/" target="_blank" rel="noopener noreferrer" className="text-main md:text-muted dark:text-main/70 hover:text-main transition-colors">
                                            <Instagram size={22} />
                                        </a>
                                    </div>
                                </nav>
