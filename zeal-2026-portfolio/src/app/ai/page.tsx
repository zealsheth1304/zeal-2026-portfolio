import { getAllAI } from "@/lib/mdx";
import Link from "next/link";
import Image from "next/image";

export default function AIPage() {
  const projects = getAllAI();
    ...
    <div className="pt-40 pb-20 px-12 md:px-16 max-w-7xl mx-auto">
      <header className="mb-ds-24 max-w-4xl">
        ...
        <h1 className="text-7xl md:text-ds-h1 font-bold tracking-ds-tight text-main mb-ds-8">
          AI <span className="high-status-heading italic text-primary">Projects.</span>
        </h1>
        <p className="text-ds-b1 text-muted max-w-3xl leading-relaxed font-medium">
          A collection of experiments and projects exploring artificial intelligence tools, AI agents, large language models, and machine learning.
        </p>
      </header>
        ...
        {projects.map((project, idx) => (
          ...
          >
            ...
            <div className="flex flex-col gap-ds-3 w-full px-2">
              {/*<span className="text-[10px] font-mono text-muted opacity-40">A0{idx + 1}</span>*/}
